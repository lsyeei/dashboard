...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QSizePolicy sizePolicy5(QSizePolicy::Policy::Preferred, QSizePolicy::Policy::Minimum);
        ...
        sizePolicy6.setHeightForWidth(graphicProperty->sizePolicy().hasHeightForWidth());
        graphicProperty->setSizePolicy(sizePolicy6);
