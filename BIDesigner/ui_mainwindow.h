...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy1.setHeightForWidth(graphicItems->sizePolicy().hasHeightForWidth());
        graphicItems->setSizePolicy(sizePolicy1);
        ...
        sizePolicy4.setHeightForWidth(graphicProperty->sizePolicy().hasHeightForWidth());
        graphicProperty->setSizePolicy(sizePolicy4);
