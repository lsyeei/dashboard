...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/app.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        if (QIcon::hasThemeIcon(QIcon::ThemeIcon::DocumentSave)) {
            ...
            icon1.addFile(QString::fromUtf8(":/icons/icons/save.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        }
        doSave->setIcon(icon1);
        ...
        if (QIcon::hasThemeIcon(QIcon::ThemeIcon::EditUndo)) {
            icon2 = QIcon::fromTheme(QIcon::ThemeIcon::EditUndo);
        } else {
            icon2.addFile(QString::fromUtf8(":/icons/icons/Undo.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        }
        undo->setIcon(icon2);
        ...
        if (QIcon::hasThemeIcon(QIcon::ThemeIcon::EditRedo)) {
            icon3 = QIcon::fromTheme(QIcon::ThemeIcon::EditRedo);
        } else {
            icon3.addFile(QString::fromUtf8(":/icons/icons/Redo.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        }
        redo->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/icons/group.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        group->setIcon(icon4);
        group->setMenuRole(QAction::MenuRole::NoRole);
        ungroup = new QAction(MainWindow);
        ungroup->setObjectName("ungroup");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/icons/ungroup.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ungroup->setIcon(icon5);
        ...
        if (QIcon::hasThemeIcon(QIcon::ThemeIcon::ZoomIn)) {
            icon6 = QIcon::fromTheme(QIcon::ThemeIcon::ZoomIn);
        } else {
            icon6.addFile(QString::fromUtf8(":/icons/icons/zoom in.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        }
        ...
        if (QIcon::hasThemeIcon(QIcon::ThemeIcon::ZoomOut)) {
            icon7 = QIcon::fromTheme(QIcon::ThemeIcon::ZoomOut);
        } else {
            icon7.addFile(QString::fromUtf8(":/icons/icons/zoom out.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        }
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/icons/bring-to-downer.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        toFront->setIcon(icon8);
        toFront->setMenuRole(QAction::MenuRole::NoRole);
        toBack = new QAction(MainWindow);
        toBack->setObjectName("toBack");
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/icons/bring-to-upper.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        toBack->setIcon(icon9);
        toBack->setMenuRole(QAction::MenuRole::NoRole);
        toTop = new QAction(MainWindow);
        toTop->setObjectName("toTop");
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/icons/bring-to-top.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        toTop->setIcon(icon10);
        toTop->setMenuRole(QAction::MenuRole::NoRole);
        toBottom = new QAction(MainWindow);
        toBottom->setObjectName("toBottom");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/icons/bring-to-bottom.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        toBottom->setIcon(icon11);
        toBottom->setMenuRole(QAction::MenuRole::NoRole);
        alignLeft = new QAction(MainWindow);
        alignLeft->setObjectName("alignLeft");
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icons/icons/Aligne-left.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alignLeft->setIcon(icon12);
        alignLeft->setMenuRole(QAction::MenuRole::NoRole);
        alignRight = new QAction(MainWindow);
        alignRight->setObjectName("alignRight");
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/icons/icons/Aligne-right.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alignRight->setIcon(icon13);
        alignRight->setMenuRole(QAction::MenuRole::NoRole);
        alignTop = new QAction(MainWindow);
        alignTop->setObjectName("alignTop");
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/icons/icons/Aligne-up.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alignTop->setIcon(icon14);
        alignTop->setMenuRole(QAction::MenuRole::NoRole);
        alignBottom = new QAction(MainWindow);
        alignBottom->setObjectName("alignBottom");
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/icons/icons/Aligne-down.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alignBottom->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/icons/icons/Aligne-vertical-midl.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alignHorizon->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/icons/icons/Aligne-midle.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        alignVertical->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/icons/icons/Distribute-vertical .svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        distributeHorizon->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/icons/icons/Distribute-midle.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        distributeVertical->setIcon(icon19);
        distributeVertical->setMenuRole(QAction::MenuRole::NoRole);
        doExit = new QAction(MainWindow);
        doExit->setObjectName("doExit");
        QIcon icon20(QIcon::fromTheme(QString::fromUtf8("application-exit")));
        doExit->setIcon(icon20);
        doExit->setMenuRole(QAction::MenuRole::QuitRole);
        doCreate = new QAction(MainWindow);
        doCreate->setObjectName("doCreate");
        QIcon icon21(QIcon::fromTheme(QString::fromUtf8("document-new")));
        doCreate->setIcon(icon21);
        doOpen = new QAction(MainWindow);
        doOpen->setObjectName("doOpen");
        QIcon icon22(QIcon::fromTheme(QString::fromUtf8("document-open")));
        doOpen->setIcon(icon22);
        doExport = new QAction(MainWindow);
        doExport->setObjectName("doExport");
        doCut = new QAction(MainWindow);
        doCut->setObjectName("doCut");
        QIcon icon23(QIcon::fromTheme(QIcon::ThemeIcon::EditCut));
        doCut->setIcon(icon23);
        doCopy = new QAction(MainWindow);
        doCopy->setObjectName("doCopy");
        QIcon icon24(QIcon::fromTheme(QIcon::ThemeIcon::EditCopy));
        doCopy->setIcon(icon24);
        doPast = new QAction(MainWindow);
        doPast->setObjectName("doPast");
        QIcon icon25(QIcon::fromTheme(QIcon::ThemeIcon::EditPaste));
        doPast->setIcon(icon25);
        ...
        QIcon icon26;
        icon26.addFile(QString::fromUtf8(":/icons/icons/preview.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        doPreview->setIcon(icon26);
        doPreview->setMenuRole(QAction::MenuRole::NoRole);
        doAbout = new QAction(MainWindow);
        doAbout->setObjectName("doAbout");
        QIcon icon27(QIcon::fromTheme(QString::fromUtf8("help-about")));
        doAbout->setIcon(icon27);
        ...
        QIcon icon28;
        icon28.addFile(QString::fromUtf8(":/icons/icons/flip_horizontal.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        flipHorizontal->setIcon(icon28);
        ...
        QIcon icon29;
        icon29.addFile(QString::fromUtf8(":/icons/icons/flip_vertical.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        flipVertical->setIcon(icon29);
        flipVertical->setMenuRole(QAction::MenuRole::NoRole);
        saveToLib = new QAction(MainWindow);
        saveToLib->setObjectName("saveToLib");
        QIcon icon30;
        icon30.addFile(QString::fromUtf8(":/icons/icons/library-add.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        saveToLib->setIcon(icon30);
        saveToLib->setMenuRole(QAction::MenuRole::NoRole);
        doDelete = new QAction(MainWindow);
        doDelete->setObjectName("doDelete");
        QIcon icon31(QIcon::fromTheme(QIcon::ThemeIcon::EditDelete));
        doDelete->setIcon(icon31);
        doDelete->setMenuRole(QAction::MenuRole::NoRole);
        dataSource = new QAction(MainWindow);
        dataSource->setObjectName("dataSource");
        QIcon icon32;
        icon32.addFile(QString::fromUtf8(":/icons/icons/datasource.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        dataSource->setIcon(icon32);
        ...
        graphicItems->setMinimumSize(QSize(0, 0));
        ...
        sizePolicy3.setHeightForWidth(propertyWidget->sizePolicy().hasHeightForWidth());
        propertyWidget->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(property->sizePolicy().hasHeightForWidth());
        property->setSizePolicy(sizePolicy4);
        ...
        graphicProperty->setGeometry(QRect(0, 0, 206, 485));
        QSizePolicy sizePolicy5(QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        sizePolicy5.setHorizontalStretch(0);
        sizePolicy5.setVerticalStretch(0);
        sizePolicy5.setHeightForWidth(graphicProperty->sizePolicy().hasHeightForWidth());
        graphicProperty->setSizePolicy(sizePolicy5);
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Visual Data Studio", nullptr));
