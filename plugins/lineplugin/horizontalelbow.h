...
#ifndef HORIZONTALELBOW_H
#define HORIZONTALELBOW_H

#include <QObject>
#include "abstractlineitem.h"

class HorizontalElbow : public AbstractLineItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit HorizontalElbow(QGraphicsItem *parent = nullptr);
    explicit HorizontalElbow(const QString &xml,
...
protected:
    ...
    void afterPointMoveEnd(const QString &id) Q_DECL_OVERRIDE;
