...
class CurvedLine : public AbstractLineItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit CurvedLine(QGraphicsItem *parent = nullptr);
    explicit CurvedLine(const QString &xml, QGraphicsItem *parent = nullptr);
