...
#ifndef POLYGONLINE_H
#define POLYGONLINE_H

#include <QObject>
#include "abstractlineitem.h"

class PolygonLine : public AbstractLineItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit PolygonLine(QGraphicsItem *parent = nullptr);
    explicit PolygonLine(const QString &xml, QGraphicsItem *parent = nullptr);
