...
inline LineBaseProperty::LineBaseProperty() : BaseProperty(){
...
inline QRectF LineBaseProperty::getLogicRect(){return {-width/2, -height/2, width, height};}

inline QList<QPointF> LineBaseProperty::getPoints(){
...
inline int LineBaseProperty::getPointCount(){return pointList.count();}

inline void LineBaseProperty::updatePoint(const QString &id, QPointF point){
...
inline QString LineBaseProperty::insertPoint(QPointF point, const QString &beforePoint){
...
inline QString LineBaseProperty::appendPoint(QPointF point){
    QString id = QString::number(++maxId);
    NamedPoint item{id, point};
...
inline void LineBaseProperty::removePoint(const QString &id){
