...
#ifndef CHARTPROPERTYFORM_H
#define CHARTPROPERTYFORM_H

#include "chartproperty.h"
#include "ipropertyform.h"
#include <QTextCharFormat>

class AbstractGoogleChart;
class ISubWidget;
namespace Ui {
class ChartPropertyForm;
}

class ChartPropertyForm : public IPropertyForm
{
    Q_OBJECT

public:
    explicit ChartPropertyForm(QWidget *parent = nullptr);
    ~ChartPropertyForm();
...
private:
    Ui::ChartPropertyForm *ui;
    // 图形元件
    AbstractGoogleChart *graphicItem{nullptr};
    // 属性
    ChartProperty attr;
