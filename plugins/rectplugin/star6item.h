...
class Star6Item : public AbstractZoneItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit Star6Item(QGraphicsItem *parent = nullptr);
    explicit Star6Item(const QString &xml, QGraphicsItem *parent = nullptr);
