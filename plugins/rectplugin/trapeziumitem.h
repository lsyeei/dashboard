...
#ifndef TRAPEZIUMITEM_H
#define TRAPEZIUMITEM_H

#include <QObject>
#include <abstractzoneitem.h>

class TrapeziumItem : public AbstractZoneItem
{
    Q_OBJECT
public:
    static QString SHAPE_ID;
    explicit TrapeziumItem(QGraphicsItem *parent = nullptr);
    explicit TrapeziumItem(const QString &xml, QGraphicsItem *parent = nullptr);
