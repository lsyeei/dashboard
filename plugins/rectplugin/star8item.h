...
class Star8Item : public AbstractZoneItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit Star8Item(QGraphicsItem *parent = nullptr);
    explicit Star8Item(const QString &xml, QGraphicsItem *parent = nullptr);
