...
#ifndef QUADRANGLEITEM_H
#define QUADRANGLEITEM_H

#include <QObject>
#include <abstractzoneitem.h>

class QuadrangleItem : public AbstractZoneItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit QuadrangleItem(QGraphicsItem *parent = nullptr);
    explicit QuadrangleItem(const QString &xml,
...
private:
    ...
    AdjustPoint *tiltLAdjuster{nullptr};
    AdjustPoint *tiltRAdjuster{nullptr};
};

#endif // QUADRANGLEITEM_H
