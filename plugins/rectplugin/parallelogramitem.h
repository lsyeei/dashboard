...
class ParallelogramItem : public AbstractZoneItem
{
    Q_OBJECT
public:
    static QString SHAPE_ID;
    explicit ParallelogramItem(QGraphicsItem *parent = nullptr);
    explicit ParallelogramItem(const QString &xml, QGraphicsItem *parent = nullptr);
