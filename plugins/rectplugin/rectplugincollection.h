...
#ifndef RECTPLUGINCOLLECTION_H
#define RECTPLUGINCOLLECTION_H

#include <igraphicpluginCollection.h>


class RectPluginCollection : public QObject, public IGraphicPluginCollection
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "cn.devhome.BIDEsigner.IGraphicPluginCollection")
    Q_INTERFACES(IGraphicPluginCollection)
public:
    RectPluginCollection();
    ~RectPluginCollection();
