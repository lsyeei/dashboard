...
class SectorItem : public AbstractZoneItem
{
    Q_OBJECT

public:
    static QString SHAPE_ID;
    explicit SectorItem(QGraphicsItem *parent = nullptr);
    explicit SectorItem(const QString &xml, QGraphicsItem *parent = nullptr);
...
protected slots:
    ...
    void onAdjusterMove(const QPointF &from, const QPointF &to);
private:
    void updateAdjuster();
    AdjustPoint *directAdjuster{nullptr}, *ellipseAdjuster{nullptr};
};
